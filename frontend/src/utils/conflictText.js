...
const RULE_PLAIN = {
  ...
  'R-05': 'A room is booked for two classes at the same time.',
  ...
  'R-10': 'A section has no room assigned.',
  'R-11': 'A lab is placed in a room that is not a lab.',
  'R-12': 'A lecture is placed in a lab room.',
